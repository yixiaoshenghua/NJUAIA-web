<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tech-department_login.aspx.cs" Inherits="members_Tech_department_login" %>
      ...
      <div id="topbar" class="hoc clear">
        <div class="fl_right">
          <ul>
              ...
              <li><a href="/personList/person1.aspx">Personal</a></li>
          </ul>
      </div>
    </div>
      ...
      <div id="comments">
        ...
        <ul>
          <li>
            <article>
              <header>
                <figure class="avatar"><asp:Image ID="img01" runat="server" alt="" style="width:100px; height:120px;" /></figure>
                <address>
                <a href="#"><h5><font color="#000000">万盛华</font></h5></a>
                </address>
              </header>
              <div class="comcont">
                <p><asp:Label ID="memberIntro01" runat="server"></asp:Label></p>
              </div>
            </article>
          </li>
          <li>
          ...
          <li>
            <article>
              <header>
                <figure class="avatar"><img src="" alt="" style="width:100px; height:120px;"></figure>
                <address>
                <a href="#"><h5><font color="#000000"></font></h5></a>
                </address>
              </header>
              <div class="comcont">
                <p></p>
