<%@ Page Language="C#" AutoEventWireup="true" CodeFile="personal2.aspx.cs" Inherits="personList_personal2" %>
...
<body>
    <form runat="server">
            <asp:Table ID="msform" runat="server" Height="611px" Width="804px" BorderColor="Black" HorizontalAlign="Justify">
                <asp:TableRow>
                    <asp:TableCell BorderColor="Black" BorderStyle="Solid">
                        ...
                        <asp:TextBox ID="education" runat="server" name="education" placeholder="本科"></asp:TextBox>
                        <asp:TextBox ID="college" runat="server" name="college" placeholder="地理与海洋科学学院"></asp:TextBox>
                        ...
                        <asp:TextBox ID="QQ" runat="server" name="QQ" placeholder="QQ"></asp:TextBox>
